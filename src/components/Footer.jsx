...
function Footer() {
    ...
    return (
        <div data-scroll data-scroll-section data-scroll-speed="-.1" className='w-full h-screen py-20 px-16 flex rounded-t-3xl bg-zinc-900'>
            <div className='w-1/2 flex flex-col justify-between'>
                <div className="headings">
                <h1 className='font-[foundersGrotesk] text-9xl'>EYE-</h1>
                <h1 className='font-[foundersGrotesk] text-9xl'>OPENING</h1>
                </div>
            <div>
